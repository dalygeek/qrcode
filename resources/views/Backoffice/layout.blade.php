...
<head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{asset('images/qrbox.png')}}">

        <!-- preloader css -->
        <link rel="stylesheet" href="{{asset('Backoffice/css/preloader.min.css')}}" type="text/css" />
        
        <!-- DataTables -->
        <link href="{{asset('Backoffice/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />

        <!-- Responsive datatable examples -->
        <link href="{{asset('Backoffice/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <!-- <body data-layout="horizontal"> -->
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="/" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{asset('images/qrbox.png')}}" alt="" height="30">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{asset('images/qrbox.png')}}" alt="" height="24"> <span class="logo-txt">Thor QR</span>
                                </span>
                            </a>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="https://i.ibb.co/zVcRR1B/images.jpg"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium">Thor System</span>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{route('showListeUsers')}}">
                                    <i data-feather="users"></i>
                                    <span data-key="t-contacts">Utilisateurs</span>
                                </a>
                            ...
                            <li>
                                <a href="{{route('showListeQrs')}}">
                                    <i data-feather="list"></i>
                                    <span data-key="t-contacts">Qr Codes</span>
                                </a>
                            ...
                            <li>
                                <a href="{{route('showChart')}}">
                                    ...
                                    <span data-key="t-contacts">Statistiques</span>
                                </a>
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © Thor system
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Design & Develop by <a href="#!" class="text-decoration-underline">Thor System</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- init js -->
        <script src="{{asset('Backoffice/js/pages/datatable-pages.init.js')}}"></script>
