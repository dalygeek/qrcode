...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Liste des QR Codes</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">QR Codes</a></li>
                    <li class="breadcrumb-item active">Liste des QR Codes</li>
                </ol>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <h5 class="card-title">Liste des QR Codes</h5>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                            ...
                            <div>
                                <a href="{{route('showAddQr')}}" class="btn btn-light"><i class="bx bx-plus me-1"></i> Ajouter Un QR Code</a>
                            </div>
                ...
                <div class="table-responsive mb-4">
                    <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                        ...
                        <tr>
                            ...
                            <th scope="col">Nom du QR Code</th>
                            {{-- <th scope="col">Position</th> --}}
                            <th scope="col">Contenu</th>
                            <th scope="col">lien static</th>
                            <th scope="col">Nombres de scans</th>
                        ...
                        <tbody>
                            @foreach ($qrs as $qr)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-body">{{$qr->name}}</a>
                                    </td>
                                    {{-- <td>UI/UX Designer</td> --}}
                                    <td>{{$qr->dynamic_link}}</td>
                                    
                                        <td>{{$qr->static_link}}</td>
